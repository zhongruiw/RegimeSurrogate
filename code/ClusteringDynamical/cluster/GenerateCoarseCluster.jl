...
function coarse_cluster(X, dt, indices, τ, qmins; factor=10, iteration1=3, iteration2=5, file=false)
    ...
    Qt_pert_array = []
    if file != false
        clustername = "/Users/ree/Documents/Research/RegimeSurrogate/code/ClusteringDynamical/data/" * file * "_coarse_cluster.hdf5"
...
function read_coarse_cluster(file)
    hfile = h5open("/Users/ree/Documents/Research/RegimeSurrogate/code/ClusteringDynamical/data/" * file * "_coarse_cluster.hdf5")
